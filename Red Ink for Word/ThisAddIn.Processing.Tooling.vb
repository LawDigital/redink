...
'          per-tool execution, response injection back into subsequent LLM
'          iterations, and host-owned major-step progress reporting in both main
'          and isolated sub-agent loops.
'
' Architecture:
