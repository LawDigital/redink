...
Partial Class Ribbon1
    ...
    Public Async Function InitializeAppAsync() As Task
        ...
        If SharedMethods.IsImageGenerationAvailable(ThisAddIn._context) Then
            SetRibbonControlVisibleByAvailability(Me.RI_Image, True)
        Else
            SetRibbonControlVisibleByAvailability(Me.RI_Image, False)
        End If
        ...
        ApplySimpleModeToRibbonControls(ThisAddIn.INI_SimpleMenuHide, ThisAddIn.INI_MenuBlock, ThisAddIn.INI_SimpleMenuOverride)
