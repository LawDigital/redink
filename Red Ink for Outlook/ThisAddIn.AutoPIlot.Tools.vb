    ...
    Friend Function GetAutoPilotInternalTools() As List(Of ModelConfig)
        ...
        tools.Add(New ModelConfig() With {
            ...
            .ToolInstructionsPrompt =
                ...
                "For visual, keep label/title text short and put only concise supporting wording in detail/body. Use type='process' for true sequences, type='structure' for ownership/reporting/entity relationships, type='comparison' for alternatives, type='cards' for parallel themes, type='timeline' for dated milestones, type='matrix' for two-dimensional positioning, type='kpi' for headline metrics, and type='chart' only for genuine quantitative data. " &
