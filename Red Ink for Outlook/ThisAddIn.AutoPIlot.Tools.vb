    ...
    Friend Function GetAutoPilotInternalTools() As List(Of ModelConfig)
        ...
        tools.Add(New ModelConfig() With {
            ...
            .ToolDefinition =
                ...
                """parameters"":{""type"":""object"",""properties"":{" &
                """markdown_content"":{""type"":""string"",""description"":""Full document content in Markdown. Use headings, concise bullets, emphasis, and Markdown tables where useful. When the selected Word design exposes a native body-style contract, use only the heading and list levels declared by that contract; unsupported levels are rejected.""}," &
